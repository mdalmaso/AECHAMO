...
part_source(:,:,1) = [tvect' [zeros(859,1);6.3.*ones(37,1);zeros(length(tvect)-859-37,1)], 10e-9.*ones(length(tvect),1)];
part_source(:,:,2) = [tvect' [zeros(859,1);zeros(35,1);1.5.*ones(95,1);2.7.*ones(190,1);zeros(length(tvect)-859-35-95-190,1)], 18e-9.*ones(length(tvect),1)];
