...
part_source(:,:,2) = [tvect' [zeros(80,1);1.7.*ones(32,1);2.03.*ones(123,1);2.18.*ones(82,1);zeros(length(tvect)-80-35-120-82,1)], 18e-9.*ones(length(tvect),1)];
...
% gas_source = [tvect' [interp1(timehours.*3600,Q(begin1:end),tvect(1:317)),zeros(1,length(tvect)-317)]'];
