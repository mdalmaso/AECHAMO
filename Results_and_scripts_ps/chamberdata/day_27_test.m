...
part_source(:,:,1) = [tvect' [zeros(1,1);0.05.*ones(64,1);0.16.*ones(45,1);0.28.*ones(47,1);0.37.*ones(81,1);zeros(length(tvect)-65-45-47-81,1)], 18e-9.*ones(length(tvect),1)];
...
gas_source = [tvect' [1e7.*ones(1,238),zeros(1,length(tvect)-238)]'];
