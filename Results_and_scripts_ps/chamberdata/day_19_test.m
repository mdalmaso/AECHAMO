...
part_source(:,:,2) = [tvect' [zeros(39,1);1.92.*ones(30,1);0.9.*ones(14,1);1.55.*ones(56,1);2.2.*ones(170,1);1.45.*ones(8,1);zeros(length(tvect)-39-30-15-55-170-8,1)], 18e-9.*ones(length(tvect),1)];
