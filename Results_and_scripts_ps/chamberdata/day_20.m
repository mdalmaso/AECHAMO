...
part_source(:,:,1) = [tvect' [zeros(868,1);1.64.*ones(105,1);zeros(length(tvect)-868-105,1)], 10e-9.*ones(length(tvect),1)];
part_source(:,:,2) = [tvect' [zeros(868,1);zeros(105,1);2.05.*ones(210,1);zeros(length(tvect)-868-105-210,1)], 18e-9.*ones(length(tvect),1)];
