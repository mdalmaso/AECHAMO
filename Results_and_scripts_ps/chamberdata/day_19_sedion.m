...
part_source(:,:,1) = [tvect' [4.05.*ones(39,1);zeros(length(tvect)-39,1)], 10e-9.*ones(length(tvect),1)];
part_source(:,:,2) = [tvect' [zeros(39,1);2.42.*ones(30,1);1.35.*ones(18,1);1.85.*ones(52,1);2.6.*ones(170,1);2.1.*zeros(8,1);zeros(length(tvect)-39-30-15-55-170-8,1)], 18e-9.*ones(length(tvect),1)];
